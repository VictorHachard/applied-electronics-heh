...
void main(void) {
    ...
    INTCON0 = 0b10000000; //Activation des interruptions non masquées, sans priorités
    PIE0    = 0b10000000; //Activation des interruptions "on change" des GPIOs
    IOCAN   = 0b11000000; //Interruption flanc descendant sur RA7 et RA6
    IOCCN   = 0b00000001; //Interruption flanc descendant sur RC0
    
    /*
    //Bloc2 : activation de l'interruption sur réception UART1
    PIE3bits.U1RXIE = 1;
    */
    ...
    U1CON0bits.RXEN = 1; //activation réception RX UART1
...
{
    if (IOCAFbits.IOCAF7 == 1) //Interruption sur RA7
    {
        PORTCbits.RC2 = !PORTCbits.RC2; 
        IOCAFbits.IOCAF7 = 0;
    }
    if (IOCAFbits.IOCAF6 == 1) //Interruption sur RA6
    {
        PORTBbits.RB5 = !PORTBbits.RB5; 
        IOCAFbits.IOCAF6 = 0;
    }
    if (IOCCFbits.IOCCF0 == 1) //Interruption sur RC0
    {
    ...
    /*
    //BLOC 2 : gestion de l'interruption sur réception UART1
    if (PIR3bits.U1RXIF == 1) //Interruption sur réception UART1
    {
        if (U1RXB == 65)
        {
            U1TXB = 66;
