...
char getMode(char ra6state, char ra7state, char rc1state) {





    if (PORTAbits.RA6 == 0 && ra6state == 1)
    {
        ra6state = 0;
        _delay((unsigned long)((5)*(64000000/4000.0)));
    }
    if (PORTAbits.RA7 == 0 && ra7state == 1)
    {
        ra7state = 0;
        _delay((unsigned long)((5)*(64000000/4000.0)));
    }
    if (PORTCbits.RC1 == 0 && rc1state == 1)
    {
        rc1state = 0;
        _delay((unsigned long)((5)*(64000000/4000.0)));
    }
    if (PORTAbits.RA6 == 1 && ra6state == 0)
    {
        ra6state = 1;
        _delay((unsigned long)((5)*(64000000/4000.0)));
    }
    if (PORTAbits.RA7 == 1 && ra7state == 0)
    {
        ra7state = 1;
        _delay((unsigned long)((5)*(64000000/4000.0)));
    }
    if (PORTCbits.RC1 == 1 && rc1state == 0)
    {
        rc1state = 1;
        _delay((unsigned long)((5)*(64000000/4000.0)));
    }
    if (ra6state == 0) return 1;
    if (ra7state == 0) return 2;
    if (rc1state == 0) return 3;
    return 0;
}
...
void main(void) {
    ...
    while(1)
    {
        ...
        mode = getMode(ra6state, ra7state, rc1state);
        if (mode != lastmode) {
            timer = 0;
            lastmode = mode;
        }
